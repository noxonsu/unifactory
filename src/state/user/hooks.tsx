 ...
 */
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token], factory: string): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB, factory), 18, LP_TOKEN_SYMBOL, LP_TOKEN_NAME)
}
