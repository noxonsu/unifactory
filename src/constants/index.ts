...
import { injected, newWalletConnect, newWalletlink, Network } from '../connectors'
...
export const STORAGE_NETWORK: Network = networks[STORAGE_NETWORK_ID.toString() as STORAGE_NETWORK]
export const STORAGE_NETWORK_NAME = STORAGE_NETWORK.name
export const STORAGE = STORAGE_NETWORK.storage || ''
