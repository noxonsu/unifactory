...
export const STORAGE_NETWORK_ID = GOERLI_ID //process.env.NODE_ENV === 'production' ? BSC_ID : GOERLI_ID //POLIGON_ZKEVM_TESTNET_ID // AVALANCHE_TESTNET_ID // POLIGON_ZKEVM_TESTNET_ID
